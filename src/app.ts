...
import adminSettlementBatchRoutes from './route/admin/settlementBatch.routes';
...
app.use('/api/v1/admin/settlement-batch', authMiddleware, adminSettlementBatchRoutes);
